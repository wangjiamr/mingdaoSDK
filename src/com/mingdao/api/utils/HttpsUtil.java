...
public class HttpsUtil {
    ...
    public static ResponseObject httpByGet2RObjSSL(String url, String paramsCharset,
    ...
    public static String httpByPost2StringSSL(String url, Map<String, String> params,String paramsCharset,
                                             String resultCharset) {
        if (url == null || "".equals(url)) {
            return null;
        }
    ...
    public static ResponseObject httpByPost2RObjSSL(String url, Map<String, String> params,String paramsCharset,
                                              String resultCharset) {
        if (url == null || "".equals(url)) {
            return null;
        }
    ...
    public static ResponseObject httpByPostXMLObjSSL(String url, Map<String, String> params,String paramsCharset,
                                                    String resultCharset) {
        if (url == null || "".equals(url)) {
            return null;
        }
        ...
        try {
            ...
            if(params!=null&&!params.isEmpty()){
                ...
                if(StringUtils.isNotBlank(content)){
                    StringEntity s = new StringEntity(content.toString(),"utf-8");
    ...
    public static ResponseObject httpByPostJSONObjSSL(String url, Map<String, String> params,String paramsCharset,
                                                      String resultCharset) {
        if (url == null || "".equals(url)) {
            return null;
        }
